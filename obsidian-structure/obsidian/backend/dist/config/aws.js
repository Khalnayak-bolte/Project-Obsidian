...
export const S3_CONFIG = {
    ...
    workspacePrefix: (workspaceId) => `workspaces/${workspaceId}`,
    fileKey: (workspaceId, fileId, filename) => `workspaces/${workspaceId}/files/${fileId}/${filename}`,
    avatarKey: (userId) => `avatars/${userId}`,
};
// EventBridge config
