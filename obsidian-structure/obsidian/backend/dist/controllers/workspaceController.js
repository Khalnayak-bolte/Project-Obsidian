...
import { CreateWorkspaceSchema, UpdateWorkspaceSchema, InviteMemberSchema, BulkInviteMembersSchema, AcceptInviteSchema, UpdateMemberRoleSchema, DeleteWorkspaceSchema, TransferOwnershipSchema, UpdatePresenceSchema, WorkspaceMembersQuerySchema, } from "../schemas/workspace.schema";
import { createWorkspace as createWorkspaceService, getWorkspace, updateWorkspace as updateWorkspaceService, deleteWorkspace as deleteWorkspaceService, inviteMember as inviteMemberService, bulkInviteMembers, acceptInvite as acceptInviteService, removeMember as removeMemberService, updateMemberRole as updateMemberRoleService, transferOwnership as transferOwnershipService, listMembers as listMembersService, updatePresence as updatePresenceService, getWorkspaceStats as getWorkspaceStatsService, } from "../services/workspaceService";
...
export async function createWorkspace(req, res, next) {
    try {
        ...
        res.status(HTTP_STATUS.CREATED).json(successResponse(workspace, "Workspace created successfully."));
    }
    catch (err) {
        next(err);
    }
...
export async function updateWorkspace(req, res, next) {
    try {
        ...
        res.status(HTTP_STATUS.OK).json(successResponse(workspace, "Workspace updated successfully."));
    }
    catch (err) {
        next(err);
    }
...
export async function deleteWorkspace(req, res, next) {
    try {
        ...
        res.status(HTTP_STATUS.OK).json(successResponse(null, "Workspace deleted successfully."));
    }
    catch (err) {
        next(err);
    }
...
export async function listMembers(req, res, next) {
    try {
        ...
        res.status(HTTP_STATUS.OK).json(successResponse(result.members, undefined, {
            limit: query.limit,
...
export async function inviteMember(req, res, next) {
    try {
        ...
        res.status(HTTP_STATUS.CREATED).json(successResponse(result, "Invitation sent successfully."));
    }
    catch (err) {
        next(err);
    }
...
export async function inviteMembersBulk(req, res, next) {
    try {
        const authedReq = req;
        const uid = authedReq.user.uid;
        const { workspaceId } = req.params;
        ...
        res.status(HTTP_STATUS.OK).json(successResponse(result, `${result.sent.length} invitation(s) sent.`));
    }
    catch (err) {
        next(err);
    }
...
export async function acceptInvite(req, res, next) {
    try {
        ...
        res.status(HTTP_STATUS.OK).json(successResponse(null, "You have joined the workspace."));
    }
    catch (err) {
        next(err);
    }
...
export async function updateMemberRole(req, res, next) {
    try {
        ...
        res.status(HTTP_STATUS.OK).json(successResponse(null, "Member role updated successfully."));
    }
    catch (err) {
        next(err);
    }
...
export async function removeMember(req, res, next) {
    try {
        ...
        res.status(HTTP_STATUS.OK).json(successResponse(null, "Member removed from workspace."));
    }
    catch (err) {
        next(err);
    }
...
export async function transferOwnership(req, res, next) {
    try {
        ...
        res.status(HTTP_STATUS.OK).json(successResponse(null, "Workspace ownership transferred successfully."));
    }
    catch (err) {
        next(err);
    }
...
export async function updatePresence(req, res, next) {
    try {
        ...
        res.status(HTTP_STATUS.OK).json(successResponse({ status: body.status }, "Presence updated."));
    }
    catch (err) {
        next(err);
    }
