...
const fileNameField = z
    ...
    .refine((name) => !/[<>:"/\\|?*\x00-\x1f]/.test(name), "File name contains invalid characters.");
...
export const UpdateFileMetadataSchema = z
    ...
    .refine((data) => data.name !== undefined || data.description !== undefined, { message: "At least one field must be provided to update." });
// ─── Delete File ──────────────────────────────────────────────────────────────
