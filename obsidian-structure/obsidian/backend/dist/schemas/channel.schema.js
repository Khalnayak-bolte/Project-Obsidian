...
export const UpdateChannelSchema = z
    ...
    data.isArchived !== undefined, { message: "At least one field must be provided to update." });
// ─── Reorder Channels ─────────────────────────────────────────────────────────
...
export const UpdateCategorySchema = z
    ...
    data.channelIds !== undefined, { message: "At least one field must be provided to update." });
