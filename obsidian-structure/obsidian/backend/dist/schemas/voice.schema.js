...
export const ParticipantStatusEnum = z.enum(["connected", "connecting", "disconnected", "kicked"], {
    errorMap: () => ({
        message: "Participant status must be one of: connected, connecting, disconnected, kicked.",
    }),
});
...
export const UpdateParticipantStateSchema = z
    ...
    data.isSpeaking !== undefined, { message: "At least one participant state field must be provided." });
// ─── Start Screen Share ───────────────────────────────────────────────────────
...
//# sourceMappingURL=voice.schema.js.map