...
import {
  ...
  listChannels as listChannelsService,
  ...
  markChannelRead as markChannelReadService,
  updateChannelPermissions as updateChannelPermissionsService,
  addChannelMembers as addChannelMembersService,
  getVoiceChannels as getVoiceChannelsService,
...
export async function listChannels(
  ...
  try {
    ...
    res.status(HTTP_STATUS.OK).json(
      successResponse(channels, undefined, {
        limit: query.limit,
        hasMore: false,
      })
    );
...
export async function updateChannel(
  ...
  try {
    ...
    res.status(HTTP_STATUS.OK).json(
      successResponse(channel, "Channel updated successfully.")
    );
  } catch (err) {
    next(err);
  }
...
export async function deleteChannel(
  ...
  try {
    ...
    res.status(HTTP_STATUS.OK).json(
      successResponse(null, "Channel deleted successfully.")
    );
  } catch (err) {
    next(err);
  }
...
export async function archiveChannel(
  ...
  try {
    ...
    res.status(HTTP_STATUS.OK).json(
      successResponse(
        { isArchived },
        isArchived ? "Channel archived." : "Channel unarchived."
      )
    );
  } catch (err) {
    next(err);
...
export async function reorderChannels(
  ...
  try {
    ...
    res.status(HTTP_STATUS.OK).json(
      successResponse(null, "Channels reordered successfully.")
    );
  } catch (err) {
    next(err);
  }
...
export async function markChannelRead(
  ...
  try {
    ...
    res.status(HTTP_STATUS.OK).json(
      successResponse(null, "Channel marked as read.")
    );
  } catch (err) {
    next(err);
  }
...
export async function updateChannelPermissions(
  ...
  try {
    ...
    res.status(HTTP_STATUS.OK).json(
      successResponse(null, "Channel permissions updated.")
    );
  } catch (err) {
    next(err);
  }
...
export async function addChannelMembers(
  ...
  try {
    ...
    res.status(HTTP_STATUS.OK).json(
      successResponse(
        { added: body.uids.length },
        `${body.uids.length} member(s) added to channel.`
      )
    );
  } catch (err) {
    next(err);
