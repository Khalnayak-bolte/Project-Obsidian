...
function extractToken(req: Request): string | null {
  const header = req.headers[HEADERS.AUTH] as string | undefined;
...
async function buildSession(uid: string, decoded: any): Promise<UserSession> {
...
export async function requireOwner(
  ...
  try {
    ...
    const ownerId: string = wsSnap.data()!.ownerId;
